 ...
 */
final class Version20190912101236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rating INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, calories INT NOT NULL, proteins DOUBLE PRECISION NOT NULL, fats DOUBLE PRECISION NOT NULL, carbohydrates DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE consumption ADD CONSTRAINT FK_2CFF2DF94584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    }
